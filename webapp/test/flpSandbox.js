		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#rfscannerpharmascience-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rfscannerpharmascience-display": {
								"semanticObject": "rfscannerpharmascience",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rfscanner.pharmascience",
									"url": sap.ui.require.toUrl("rfscanner/pharmascience")
								}
							}
						}
					}
